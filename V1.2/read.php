...
<HTML>
	...
	<BODY>
		...
		<br /><table cellpadding="5" cellspacing="1" width="100%" border="1">
			<thead>
			...
			<tbody>
				<?php include 'Database.php';
					$listEmploye = MaterielTable::getAllMateriel();
    				foreach ($listMateriel as $materiel) {      
       					
        				
    
                	echo '<td>' . $employe->getRefMat() . '</td>';
                	echo '<td>' . $employe->getModel() . '</td>';
                	echo '<td>' . "" . '</td>';
                	echo '<td>' . "" . '</td>';
                	echo '<td>' . "" . '</td>';
                	echo '<td>' . "" . '</td>';
